		...
		<div class="container">
			<div class="w3layouts-address">
				<ul>
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="rahmanriyaz425@gmail.com">visvesvarayatechnologicaluniversity@gmail.com</a></li>
				</ul>
			</div>
					...
					<div class="navbar-header">
					  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						...
						<div class="w3layouts-logo">
							<h1><a href="index.html">Visvesvaraya Technological<span>Belgaum</span></a></h1>
						</div>
					</div>
