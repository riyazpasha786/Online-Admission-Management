...
<html lang="en">
<head>
<title>Visvesvaraya Technological university/loginuser/</title>
...
<div>					<i class="fa fa-envelope-o" aria-hidden="true"></i> rahmanriyaz425@email.com
				</ul>
</div>			</div>
					...
					<div class="navbar-header">
					  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						...
						<div class="w3layouts-logo">
							<h1><a href="index.html">Visvesvaraya Technological University<span>Belagavi</span></a></h1>
						</div>
					</div>
